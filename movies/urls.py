...
from .views import MovieTemplateView,MovieListView,MovieDetailView,RomanceMovieListView,SuperheroMovieListView,MovieSearchView,AddMovieView
urlpatterns = [
    ...
    path('add-movie/',AddMovieView,name='add-movie'),
]
